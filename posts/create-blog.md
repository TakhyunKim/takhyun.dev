...
next.js 를 사용해보고 싶었고, SEO, SSR, SSG 등에 대한 공부를 문서를 보고 이해하는 것이 아닌 <br />
직접 코드를 짜면서 확인하고 싶은 니즈와 개인적으로 공부한 것들을 기록하는 것을 즐겨하는데,<br />
**`Notion` 을 통한 정리가 아닌 개인 기술 블로그에 작성하는 것이 직관적**이고<br />
그룹화하는데 있어서 더 좋은 효과를 가져올 수 있을 것 같아서 만들게 되었습니다.
